...
export function conversationSystemPrompt(request: AiTurnRequest): string {
  return [
    ...
    `Source briefing (the factual source of truth): ${request.scenarioBriefing}`,
    `The learner plays this role: ${request.learnerRole}`,
    ...
    "Alternate naturally between acknowledging, informing, reacting and asking. Do not turn the conversation into a questionnaire.",
