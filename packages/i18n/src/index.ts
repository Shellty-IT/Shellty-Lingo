...
const pl = {
  ...
  passwordHint: "Minimum 12 znaków. Użyj czegoś, co łatwo zapamiętasz.",
...
export const translations: Record<Locale, TranslationMap> = {
  ...
  en: {
    ...
    passwordHint: "At least 12 characters. Pick something you can remember.",
  ...
  th: {
    ...
    passwordHint: "อย่างน้อย 12 ตัวอักษร เลือกที่คุณจำได้",
